...
export function CaseViewPageClient({ caseDetails }: CaseViewPageClientProps) {
  if (!caseDetails) {
    // This should ideally be handled by the server component with notFound()
    // Or display a more user-friendly message if this component is rendered conditionally
    return (
